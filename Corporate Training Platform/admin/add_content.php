...
if(isset($_POST['submit'])){
   ...
   $thumb_folder = 'https://flz4hlbqxg.execute-api.us-east-1.amazonaws.com/pro/saa-project-bucket/'.$rename_thumb;
   ...
   $video_folder = 'https://flz4hlbqxg.execute-api.us-east-1.amazonaws.com/pro/saa-project-bucket/'.$rename_video;
